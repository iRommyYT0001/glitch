...
const DisTube = require('distube'),
 distube = new DisTube(client, { searchSongs: true, emitNewSongOnly: true }); // searchSongs'u true yaparsanız !çal müzikismi yazdığınızda size bir liste çıkar ve listeden numara ile istediğiniz müziği seçme hakkı verir
